...
contract EquipmentManagementSystem {
    ...
    // Add new equipment with name - now restricted to owner
    ...
    // Remove equipment function - now restricted to owner
    ...
    // Modified updateEquipmentStatus to accept string status - now restricted to owner
